...
import edu.alumno.helena.chat_bot_simarret.service.impl.SimarretBromistaServiceImpl;
...
public class BromasController {
    ...
    @GetMapping
    public Mono<String> getPresentationMono() {
        return bromistaService.getPresentacionMono();
    }

    @GetMapping(value = "/presentacion-flux")
    public Flux<String> getPresentationFlux() {
        // Leemos un Mono<String> y convertimos en un Flux<String> con un carácter por emisión.
    ...
    public Flux<String> getChisteFlux(@RequestParam String tema) {
        // Leemos un Flux<Character> y convertimos en un Flux<String> con un carácter por emisión.
        // Al retardo le añadimos 35 ms para simular la escritura humana
