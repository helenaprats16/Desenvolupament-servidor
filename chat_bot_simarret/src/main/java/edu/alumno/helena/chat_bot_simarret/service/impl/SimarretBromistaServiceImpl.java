package edu.alumno.helena.chat_bot_simarret.service.impl;
...
import edu.alumno.helena.chat_bot_simarret.ExternalApiException;
import edu.alumno.helena.chat_bot_simarret.event.ChisteContadoEvent;
import edu.alumno.helena.chat_bot_simarret.service.SimarretBromistaService;
...
public class SimarretBromistaServiceImpl implements SimarretBromistaService {
    ...
    public Mono<String> getPresentacionMono() {
        return webClient.get()
                ...
                .onErrorResume(e -> Mono.error(ExternalApiException.handleException(
                        e,
    ...
    // Si desde Spring Boot llamamos a un endpoint que devuelve un Mono<String> y
    // queremos convertirlo en un
    // Flux<String> para emitirlo en un cliente que espera un stream de texto,
